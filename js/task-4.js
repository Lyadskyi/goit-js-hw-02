...
// Хоча це не критично, розташування console.log в функції для тестування не є частиною самої функції і використовується тільки для
// тестування. Це хороша практика виділяти тестовий код від коду для виробництва або визначення функцій.
