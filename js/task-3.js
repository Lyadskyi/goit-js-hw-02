...
// Змінна message повторно присвоюється з нижнім регістром.
// Замість цього слід використовувати нову змінну для зберігання нормалізованого рядка.
// Це покращує читабельність і уникнення потенційного замішання.
// У цьому випадку оператор if є зайвим. Оскільки сам вираз умови if вже оцінюється як булевий,
// можна повернути результат безпосередньо: return message.includes("спам") || message.includes("розпродаж");
