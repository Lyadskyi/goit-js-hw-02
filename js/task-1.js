...
// Ти повторюєш операцію: "кількість * ціна_за_дроїда" два рази всередині оператора if. Було б більш ефективно обчислити це один раз,
// зберегти це в змінній, а потім використовувати цю змінну, як для порівняння, так і для рядкового форматування.
// Це зробить твій код більш чистим і ефективним.
